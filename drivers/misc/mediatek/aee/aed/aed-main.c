...
//WenLong.Cai@NETWORK.STABILITY, 2016/10/10, Modify for enable create DB file when modem crash on release build
    //rep_msg->cmdId = AE_IND_EXP_RAISED;
//#else
    rep_msg->cmdId = AE_IND_FATAL_RAISED;
...
//#ifdef OPLUS_FEATURE_ENABLE_MODEM_DB
//WenLong.Cai@NETWORK.STABILITY, 2016/10/10, Delete for enable create DB file when modem crash on release build
/*
