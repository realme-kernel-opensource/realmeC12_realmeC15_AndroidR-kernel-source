...
#define DUMMY_GPIO_DTNAME "mediatek,flashlights_riod"
#endif

/* TODO: define driver name */
#define DUMMY_NAME "flashlights_riod"
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
	if (get_Operator_Version() < 177 || get_Operator_Version() > 184) { // if not RIO_D,return
		err = -EFAULT;
		goto err;
	}
#endif
