...
{
	return ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 8 + 3;
}
...
UINT32 RIOD_GC02M1_SW_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
