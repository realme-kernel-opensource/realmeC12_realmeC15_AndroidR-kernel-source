...
#define PFX "riod_hi556_camera_sensor"
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_HI556, 0x57);
...
UINT32 RIOD_HI556_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
