...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
//WuSongbai@CAMERA.DRV, 2020/06/28. Add for charge status change
...
static void imgsensor_init_sensor_list(void)
{
	...
	/*Feiping.li@Cam.Drv, 20200601, add for project 19537,19538,19536,19539*/
	...
	/*Pengfei.Nie@Cam.Drv, 20200618, add for project 19301/19011*/
	if (is_project(OPPO_19301) || is_project(OPPO_19011)) {
		psensor_list =  gimgsensor_sensor_list_19301;
	}
	/*Pradeep.saini@Cam.Drv, 20200619, add for project 18593,18073*/
