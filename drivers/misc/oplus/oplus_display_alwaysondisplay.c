...
/* Zhao.Pan@MULTIMEDIA.AUDIODRIVER.FEATURE.FEEDBACK, 2020/09/24,add for mm feedback*/
...
/* Zhijun.Ye@PSW.MM.Display.LCD.Stability, 2020/06/19, add for ramless aod */
...
/*JianBin.Zhang@PSW.MM.Display.LCD.Stability, 2020/04/17, add for aod related function*/
int _set_aod_mode_by_cmdq(unsigned int mode)
{
	int ret = 0;
