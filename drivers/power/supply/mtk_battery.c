...
/* lizhijie@BSP.CHG.basic, 2020/04/30, Add for charger */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic 2020/09/28 add for battery temp compensation*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
//dengwen.wang@BSP.CHG, 2020/08/15, Add for bat temperature
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic 2020/09/24 add for ATL 4.45 battery*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BS.CHG.Basic 2020/10/15 add for battery id*/
	value = ret_value;
#endif
...
/*****************************************************************/
#ifdef OPLUS_FEATURE_CHG_BASIC
//Jianwei.Ye@BSP.CHG.Basic, 2020/06/13, add interface for kopc charging.
#include <linux/cdev.h>		/* cdev */
...
/* Lingfei.Tang@BSP.CHG.Basic, 2020/12/21, mt6765 charger bringup */
...
/* Lingfei.Tang@BSP.CHG.Basic, 2021/01/19, Modify bat_current to negative */
	return -bat_current;
#else
	return bat_current;
...
{
#ifdef OPLUS_FEATURE_CHG_BASIC
/* lizhijie@BSP.CHG.Basic, 2020/04/30, lzj Modify for charging */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic 2020/10/16 add for high precision battery temp*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic, 2020/09/22, Add for Batt_NTC ADC compensation */
	int result = 0;
	int voltage = 0;
#endif
	...
	if(is_enbale_battery_temp_compensation() == true){
		...
		if (pre_bat_temperature_val2 == 0) {
			...
			if (((dtime.tv_sec <= 20) &&
				...
				/*pmic_auxadc_debug(1);*/
#ifndef OPLUS_FEATURE_CHG_BASIC
/* lizhijie@BSP.CHG.Basic 2020/04/30 modify to reduce log */
				WARN_ON(1);
#endif
			}
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Gauge 2020/10/12 add for mtk platform gauge with ASIC*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Gauge 2020/10/12 add for mtk gauge with ASIC*/
...
void battery_update(struct mtk_battery *gm)
{
	struct battery_data *bat_data = &gm->bs_data;
#ifndef OPLUS_FEATURE_CHG_BASIC
/*LiYue@BSP.CHG.Basic, 2020/08/04, add for charging*/
...
void disable_fg(struct mtk_battery *gm)
{
	...
	gm->ui_soc = 50;
#ifndef OPLUS_FEATURE_CHG_BASIC
/*lizhijie@BSP.CHG.Basic. 2020/04/30 lzj add for charger*/
...
#ifndef OPLUS_FEATURE_CHG_BASIC
/*lizhijie@BSP.CHG.Basic. 2020/05/06 lzj add for fg*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* lizhijie@BSP.CHG.Basic, 2020/05/01, add for sdc.lock null pointer */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* lizhijie@BSP.CHG.Basic, 2020/05/01, lzj add for sdc.lock null pointer */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* lizhijie@BSP.CHG.Basic, 2020/05/01, lzj add for remove dlpt shutdown */
...
int battery_init(struct platform_device *pdev)
{
	...
	struct mtk_gauge *gauge;
#ifdef OPLUS_FEATURE_CHG_BASIC
	/* lizhijie@BSP.CHG.basic, 2020/04/30, lzj Add for charge driver */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic 2020/10/20 add for battery temp compensation*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic 2020/11/03 add for force battery full*/
...
#endif /* OPLUS_FEATURE_CHG_BASIC */
#ifdef OPLUS_FEATURE_CHG_BASIC
	/* lizhijie@BSP.CHG.basic, 2020/04/04, lzj Add for charger */
	if(is_fuelgauge_apply() == true) {
