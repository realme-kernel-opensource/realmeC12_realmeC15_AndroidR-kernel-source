...
/*shifan@bsp.tp 2020.1218 add for modifying i2c pull up resistor from 1k to 3k*/
			    ...
			    const struct mtk_pin_soc *soc)
{
	...
	int err, i;
#ifdef OPLUS_FEATURE_TP_BASIC
/*shifan@bsp.tp 2020.1218 add for modifying i2c0 pull up resistor from 1k to 3k*/
