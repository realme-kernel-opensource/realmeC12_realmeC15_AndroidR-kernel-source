...
//xijing.Zhou@MM.AUDIODRIVER.FEATURE, 2020/12/16,modify for audio bringup
...
/* Xijing.Zhou@MM.AUDIODRIVER.KERNEL, 2021/03/23, Add for solve mt6765 left headset pop noice */
	...
	if (enable) {
		if (GetAdcStatus() == false) {
			...
			if (mCodec_data->mAudio_Ana_Mux
				...
				/* Enable MICBIAS0, MISBIAS0 = 1P9V */
#ifdef OPLUS_ARCH_EXTENDS
/*Xijing.Zhou@MM.AUDIODRIVER.ACCDET, 2021/01/26,change hs mic bias1 2.7v for 206A6*/
