...
/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.HEADSETDET.1222012, 2019/03/25,
...
/* shifan@BSP.TP.FUNCTION, 2020.1117,
 * add to enable touchpanel headset mode when plug in */
...
#endif /* CONFIG_HSKEY_BLOCK */
	/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.HEADSETDET.1223267, 2019/03/27,
...
static void eint_work_callback(struct work_struct *work)
{
	if (accdet->cur_eint_state == EINT_PLUG_IN) {
		...
		/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2019/02/14,
...
#ifndef OPLUS_BUG_COMPATIBILITY
					/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2019/03/12,
					 * modified for waiting for 6s before disabling micbias */
					if (mode != 0x5) {
...
#ifdef OPLUS_FEATURE_TP_BASIC
/* shifan@bsp.tp 2020.1117 add for notifying touchpanel switch headset mode when detected plug in */
