...
//HanHuiqun@MULTIMEDIA.AUDIODRIVER.CODEC,2019/04/03, Add for aw87339
			       ...
			       int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (mic_type == MIC_TYPE_MUX_DCC_ECM_SINGLE)
			...
			/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.PLATFORM, 2019/04/02,
				     ...
				     size_t count, loff_t *pos)
{
	...
	/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.CODEC, 2019/03/12, add log for printing necessary registers */
	regmap_read(priv->regmap, MT6359_AFE_ADDA6_L_SRC_CON0_H, &value);
	n += scnprintf(buffer + n, size - n,
		       "MT6359_AFE_ADDA6_L_SRC_CON0_H = 0x%x\n", value);
	regmap_read(priv->regmap, MT6359_AFE_ADDA6_UL_SRC_CON0_L, &value);
